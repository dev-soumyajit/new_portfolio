...
import { freelanceProjects, type FreelanceProject } from "@/data/portfolio-data";
        ...
        <div className="p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground/70">Client Project</p>
            </div>
          </div>
          ...
          <div className="mt-5">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-emerald-600/90 to-teal-500/90 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90"
            >
...
export function Freelance() {
  ...
  return (
    <section id="freelance" className="relative py-20 px-4 sm:py-32 sm:px-6">
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute right-1/4 top-0 h-[500px] w-[500px] rounded-full bg-emerald-600/[0.04] blur-[120px]" />
        <div className="absolute left-0 bottom-1/4 h-[400px] w-[400px] rounded-full bg-teal-600/[0.03] blur-[100px]" />
      </div>
        ...
        <SectionReveal>
          <div className="mb-4 text-center">
            <motion.span
              ...
              viewport={{ once: true }}
              className="mx-auto mb-6 block h-px bg-gradient-to-r from-emerald-500/80 to-teal-500/80"
            />
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Production websites and applications delivered for real clients with real business impact.
            </p>
          </div>
        </SectionReveal>
                  ...
                  >
                    <div onClick={() => setSelected(project)} className="h-full">
                      <div className={`relative h-44 bg-gradient-to-br ${project.gradient} overflow-hidden`}>
                        ...
                        {/* Freelance badge */}
                        <div className="absolute left-4 top-4 flex items-center gap-1 rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-medium text-emerald-300 backdrop-blur-md">
                          <Briefcase className="h-3 w-3" /> Client Work
                        </div>
                      </div>
      ...
      <AnimatePresence>
        {selected && <FreelanceModal project={selected} onClose={() => setSelected(null)} />}
      </AnimatePresence>
    </section>
  );
}
